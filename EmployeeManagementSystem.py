...
lblAddress=Label(entries_frame,text="Adress",)
...
btnEdit=Button(btn_frame,command=update_employee,text="Update Details",width=15,font=("Calibri",16,"bold"),bg="#2980b9",fg="white",bd=0).grid(row=0,column=1,padx=10)
#
...
#
btnClear=Button(btn_frame,command=clearAll,text="Clear Details",width=15,font=("Calibri",16,"bold"),bg="#f39c12",fg="white",bd=0).grid(row=0,column=3,padx=10)
...
tree_frame.place(x=0,y=480,width=1300,height=500)

style=ttk.Style()
style.configure("mystyle.Treeview",font=('Calibri',18),rowheight=50) #modify the font fo the body

style.configure("mystyle.Treeview.Heading",font=('Calibri',18)) #modify  the  font of headings
